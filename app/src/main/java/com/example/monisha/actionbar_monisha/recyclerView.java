...
return false;
    ...
    public static recyclerView newInstance(int section_number)
    {
    ...
    public static recyclerView newInstance (HashMap<String, ?> movie)
    {
        //String ARG_MOVIE;
        recyclerView fragment = new recyclerView();
        Bundle args= new Bundle();
    ...
    Item_Adapter mRecyclerViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter =  new Item_Adapter(getActivity(),movieData.getMoviesList());
...
*/
        ...
        mRecyclerViewAdapter.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
